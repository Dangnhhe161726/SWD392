                    ...
                    <div class="tile">
                        <div class="tile-body">
                            ...
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-excel btn-sm" href="./excelmedicalhistory" title="In"><i class="fas fa-file-excel"></i> Xuất Excel</a>
                                </div>
                            </div>
                             <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody>
                                    <c:forEach var="x" items="${list}">
                                        <tr>
                                            <td>${x.id}</td>
                                            <td><fmt:formatDate value="${x.examinationDate}" pattern="yyyy-MM-dd"/></td>
                                            <td>${x.diagnosis}</td>
                                            <td>${x.prescription}</td>
                                            <td>${x.patient.fullname}</td>
                                            <td>${x.doctor.fullname}</td>
                                            <td>${x.status.name}</td>
                                            <td>
                                                <a href="./editmedicalhistory?id=${x.id}" class="btn btn-primary">Edit</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
