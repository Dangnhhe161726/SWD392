...
<div class="container">
    ...
    <a href="AddEmployee.jsp" class="btn btn-primary mb-3">Thêm nhân viên</a>  Added Bootstrap classes 
...
<td>${x.phonenumber}</td>
<td>
    <a href="updateemployee?sid=${x.id}" class="custom-link">Cập nhật</a>  Added Bootstrap classes 
    <a href="#" onclick="showMess(${x.id})" class="custom-link">Xóa</a>  Added Bootstrap classes 
</td>
</tr>
</c:forEach>
</tbody>
                                    ...
                                    <c:forEach var="x" items="${listnu}">
                                        <tr>
                                            ...
                                            <!--                <td class="table-td-center">
                                                                <a href="updateemployee?sid=${x.id}" class="custom-link">Cập nhật</a> 
                                                                <a href="#" onclick="showMess(${x.id})" class="custom-link">Xóa</a>  
                                                            </td>-->
<!--                                            <td>
                                                <button onclick="updateemployee(${x.id})">Edit</button>
                                                <button onclick="deleteemployee(${x.id})">Delete</button>
                                            </td>-->

                                            <td class="table-td-center">
                                                <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
                                                        onclick="showMess(${x.id})"><i class="fas fa-trash-alt"></i>
                                                </button>
                                                <a href="updateemployee?sid=${x.id}" class="btn btn-primary btn-sm edit" ><i class="fas fa-edit"></i></a> 
