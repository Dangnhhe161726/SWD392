        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>List Patients</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <a class="btn btn-add btn-sm" href="addpatient" title="Thêm"><i class="fas fa-plus"></i>
                                       Create Patients</a>
                                </div>
                            </div>
            ...
            <tr>
                ...
                <td>
                     <a href="detailpatient?id=${patient.id}" class="btn btn-primary btn-sm edit" title="Edit">
        <i class="fa fa-edit"></i>
    </a>

 <a href="javascript:void(0);" onclick="confirmDelete(${patient.id})" class="btn btn-primary btn-sm edit" title="Delete">
