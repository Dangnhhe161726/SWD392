...
public class EmployeeRegisterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (submit == null) {
                RequestDispatcher disp = request.getRequestDispatcher("/EmployeeRegister.jsp");
                ...
                if (user == null) {
                    int n = dao.insertNewEmployee(user_id, email, first_name, last_name, password, status, role, employee_id, fullname, dobFormatted, gender, address, phonenumber);
                    if (n > 0) {
