...
public class DoctorRegisterController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (submit == null) {
                RequestDispatcher disp = request.getRequestDispatcher("/DoctorRegister.jsp");
                ...
                if (email == null || first_name == null || last_name == null || password == null || fullname == null || dobString == null || address == null || phonenumber == null || qualification == null || specialization == null) {
                ...
                if (user == null) {
                    int n = dao.insertNewDoctor(user_id, email, first_name, last_name, password, status, role, doctor_id, fullname, dobFormatted, gender, address, specialization, qualification, phonenumber);
                    if (n > 0) {
