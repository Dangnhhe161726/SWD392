...
public class ListPatient extends HttpServlet {
    ...
    PatientDAO p = new PatientDAO();
        ...
        request.setAttribute("listPatient", listPatient); // Note the correct attribute name
...
//            option = "2";
//        } 
//        ArrayList<User> unsortedList = m.getAllCustomer();
//        request.setAttribute("option", option);
//        request.setAttribute("alist", unsortedList);
//        request.getRequestDispatcher("./Manager/ManagerCustomer.jsp").forward(request, response);
    } 
