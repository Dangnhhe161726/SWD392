<%-- 
    ...
    Created on : Mar 20, 2024, 1:09:40 AM
    Author     : ADMIN
--%>
                    ...
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <div class="row">
                                             ...
                                             <form method="post" action="detailpatient" > 
                                                 
                                                     <input type="hidden" class="form-control-sm" name="id" value="${profile.id}">
                                <div class="form-group col-md-3">
                                    <label class="control-label">FullName</label>
                                    <input value="${profile.fullname} " name="name" class="form-control"  >
                                </div>
                         
                                <div class="form-group col-md-3">
                                    <label class="control-label">Phone</label>
                                    <input value="${profile.getPhonenumber()}" name="phone" class="form-control" type="text"  >
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="exampleSelect1 control-label">Giới Tính</label>
                                    <div style="display: flex;" class="toggle-switch">
                                        <input type="radio" name="gender" value="1" id="male" ${profile.gender ? "checked" : ""} >
                                        <label for="male">Male</label>
                                        <input type="radio" name="gender" value="0" id="female" ${!profile.gender ? "checked" : ""} >
                                        <label for="female">Female</label>
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">DateOfBirth</label>
                                    <input name="dob" value="${profile.getDob()}" class="form-control" type="date" >
                                </div>
                              <div class="form-group col-md-3">
                                    <label class="control-label">Address</label>
                                    <input name="address" value="${profile.getAddress()}" class="form-control" type="text" >
                                </div>
