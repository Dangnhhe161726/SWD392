<%-- 
    ...
    Created on : Mar 19, 2024, 8:42:45 PM
    Author     : FPT SHOP
--%>
...
// Gọi sự kiện change để hiển thị ô giá trị tương ứng với giới tính mặc định
                            ...
                            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody><% 
                                    ...
                                    <tr>
                                        <td><%= s.getId()%></td>
                                        <td><%= s.getLast_name()%> <%= s.getFirst_name()%></td>
                                        <td><%= s.getEmail()%></td>
                                        <td>
                                            <% 
                                              String role = "";
                                        ...
                                        <td>
                                            <% 
                                              String status = "";
                                              int statusCode = s.getStatus()? 1 : 0;
                                              if (statusCode == 0) {
                                                status = "Vô hiệu hóa";
